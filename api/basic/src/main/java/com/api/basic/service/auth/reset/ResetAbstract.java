...
public class ResetAbstract extends AbstractService {
     ...
     * @return 登录成功结果
     */
    protected Result<?> loginSuccess(TbBasicSysUser user) {
        ...
        return Result.ok("密码重置成功", Map.of(accessTokenName, StpUtil.getTokenValue()));
    }
}
