...
@Data
@SuperBuilder
public class TbBasicSysUserRoleRelationPo extends TbBasicSysUserRoleRelation {

    public TbBasicSysUserRoleRelationPo(){
        super();
    }
    ...
    // 条件：用户id，等于
    private Integer whereUserId;
    // 条件：用户id，在列表中
    private List<Integer> whereInUserIds;
    // 条件：用户id，在列表中，or连接
    private List<Integer> whereInOrUserIds;
    // 排除条件：用户id
    private Integer whereNotUserId;
    // 条件：用户id，不在列表中
    private List<Integer> whereNotInUserIds;
    // 条件：用户id，为空
    private Boolean whereIsNullUserId;
    // 条件：用户id，不为空
    private Boolean whereIsNotNullUserId;
    // 条件：用户id，为空字符串
    private Boolean whereIsEmptyUserId;
    // 条件：用户id，不为空字符串
    private Boolean whereIsNotEmptyUserId;
    // 条件：用户id，大于
    private Integer whereGtUserId;
    // 条件：用户id，大于等于
    private Integer whereGteUserId;
    // 条件：用户id，小于
    private Integer whereLtUserId;
    // 条件：用户id，小于等于
    private Integer whereLteUserId;
    // 条件：用户id，开始范围
    private Integer whereStartUserId;
    // 条件：用户id，结束范围
    private Integer whereEndUserId;
    // 条件：角色ID，等于
     ...
     * @return 当前PO实例
     */
    public TbBasicSysUserRoleRelationPo addGroupByField(String field) {
     ...
     * @return 当前PO实例
     */
    public TbBasicSysUserRoleRelationPo setGroupByFields(List<String> groupByFields) {
