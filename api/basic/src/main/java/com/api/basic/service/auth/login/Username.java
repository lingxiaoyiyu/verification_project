...
import com.api.basic.data.dto.auth.login.UsernameDto;
 ...
 * 用户名密码登录
 */
@Service("BasicAuthUsernameLoginServiceImpl")
public class Username extends LoginAbstract {
    ...
    public Result<?> service(UsernameDto dto, HttpServletRequest request) {
        TbBasicSysUserPo queryPo = new TbBasicSysUserPo();
        queryPo.setWhereUsername(dto.getUsername());
