...
import com.api.basic.data.dto.sys.dic.DeleteDto;
 ...
 * @author 裴金伟
 */
@Service("BasicDicDeleteServiceImpl")
...
public class Delete extends AbstractService {
    ...
    public Result<?> service(DeleteDto dto) {
        ...
        if (tbBasicSysDictionaryDao.delete(po) == 0) {
     ...
     * @return 处理后的数据
     */
    protected TbBasicSysDictionaryPo handleRemoveData(DeleteDto dto){
