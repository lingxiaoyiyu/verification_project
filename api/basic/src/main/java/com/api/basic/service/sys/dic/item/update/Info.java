...
import com.api.basic.data.dto.sys.dic.item.update.InfoDto;
 ...
 * @author 裴金伟
 */
@Service("BasicDicItemUpdateInfoServiceImpl")
...
public class Info extends AbstractService {
    ...
    public Result<?> service(InfoDto dto) {
        ...
        return Result.ok("更新成功", Map.of("updatedAt", tbBasicSysDictionaryItemDao.getFieldById(dto.getId(),  TbBasicSysDictionaryItem::getUpdatedAt).orElse("")));
    }
