 ...
 * 无界unionid登录
 */
class WujieUnionId extends BaseController
{
    private $unionId;
    private $clientFrom;
    ...
    {
        Validate::validate([
            'unionId' => ['text' => 'unionId', 'rules' => ['required']],
        ]);
        
        $this->unionId = trim(Request::post('unionId'));
    ...
    protected function service()
    {
        ...
        $user = DB::table('tb_basic_sys_user')
            ->where('wujie_unionid', $this->unionId)
            ->first();
